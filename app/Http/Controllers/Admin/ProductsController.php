...
class ProductsController extends Controller {
    ...
    {
        $products = Products::with("catalogs")->with("user")->get();
...
$user = User::pluck("email", "id")->prepend('Please select', null);
	    ...
	    return view('admin.products.create', compact("catalogs", "user", "showhide"));
	}
...
$user = User::pluck("email", "id")->prepend('Please select', null);
		...
		return view('admin.products.edit', compact('products', "catalogs", "user", "showhide"));
	}
